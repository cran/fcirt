        ...
        try {
            ...
            for (int i = 1; i <= n_student; ++i) {
                ...
                for (int j = 1; j <= n_item; ++j) {
                    ...
                    stan::math::assign(num0, (1 + stan::math::exp((get_base1(alpha, j, "alpha", 1) * (3 * (thdim - get_base1(delta, j, "delta", 1)))))));
                    current_statement_begin__ = 77;
                    stan::math::assign(num1, (stan::math::exp((get_base1(alpha, j, "alpha", 1) * ((thdim - get_base1(delta, j, "delta", 1)) - get_base1(tau, j, "tau", 1)))) + stan::math::exp((get_base1(alpha, j, "alpha", 1) * ((2 * (thdim - get_base1(delta, j, "delta", 1))) - get_base1(tau, j, "tau", 1))))));
